            ...
            <div className="content_wrapper radius_30 bg_blue_9 p-2 p-md-4">
                ...
                <div className="select_form_wrapper  px-3 bg-white radius_30 d-flex align-items-center">
                    <div className="form-group  d-flex align-items-center">
                        <label htmlFor="" > <img style={{width:20,height:20}} className="d-inline-block" src={ImgUSDT} alt="" /> </label>
                        USDT
                    </div>
                ...
                <div className="select_form_wrapper px-3 bg-white radius_30 d-flex align-items-center">
                    <div className="form-group d-flex align-items-center">
                        <label htmlFor="" style={{ height: "80px" }} > <img style={{width:20,height:20}} className="d-inline-block" src={ImgLogo} alt="" /> </label>
